...
export class ExerciseNotesRepository {
  static getNotesForExercise(exerciseId: string): ExerciseNote[] {
    try {
  ...
  static addNote(exerciseId: string, noteText: string): ExerciseNote | null {
    try {
  ...
  static updateNote(id: string, noteText: string): boolean {
    try {
